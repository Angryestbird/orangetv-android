...
import com.google.samples.apps.sunflower.data.Favour
...
val testPlants = arrayListOf(
    Movie("1", "Apple", "A red fruit", 1),
    Movie("2", "B", "Description B", 1),
    Movie("3", "C", "Description C", 2)
)
...
/**
 * [Favour] object used for tests.
 */
val testGardenPlanting = Favour(testPlant.id, testCalendar, testCalendar)
