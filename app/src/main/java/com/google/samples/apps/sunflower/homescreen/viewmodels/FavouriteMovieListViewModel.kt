...
class FavouriteMovieListViewModel @Inject internal constructor(
        favouriteMovieRepository: FavouriteMovieRepository
) : ViewModel() {
    val favouriteMovies: LiveData<List<FavouriteMovies>> =
            favouriteMovieRepository.getPlantedGardens()
}