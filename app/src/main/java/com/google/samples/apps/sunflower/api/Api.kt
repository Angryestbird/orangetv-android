...
interface Api {
    ...
    @GET("/index/all.json")
    fun getTopAfter(@Path("page") page: Int): Call<List<Movie>>

    @GET("/index/all.json")
    fun getTopBefore(): Call<List<Movie>>
    ...
    companion object {
        ...
        fun create(context: Context): Api {
            var hostUrl = getHostUrl(context)
            return create(HttpUrl.parse(hostUrl)!!)
        }
